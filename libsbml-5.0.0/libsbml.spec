...
# Created     : 2009-05-26
#
# $Id: libsbml.spec.in 11776 2010-08-24 04:25:46Z mhucka $
# $HeadURL: https://sbml.svn.sourceforge.net/svnroot/sbml/trunk/libsbml/libsbml.spec.in $
#
# <!--------------------------------------------------------------------------
...
# libsbml-5.0.0-src.zip needs to be located in SOURCES directory of
