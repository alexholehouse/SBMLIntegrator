...
#
# $Id: uninstall-libsbml-pkg.sh 12784 2011-02-08 07:37:42Z mhucka $
# $HeadURL: https://sbml.svn.sourceforge.net/svnroot/sbml/branches/libsbml-5/macosx/uninstall-libsbml-pkg.sh $
#
#<!---------------------------------------------------------------------------
