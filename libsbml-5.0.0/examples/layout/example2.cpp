 ...
 * $HeadURL: https://sbml.svn.sourceforge.net/svnroot/sbml/branches/libsbml-5/examples/layout/example2.cpp $
 */
...
//
//        LayoutPkgNamespaces sbmlns(2,1);
//
...
LayoutPkgNamespaces layoutns(2,1);
...
writeSBML(document,"layout_example2_L2.xml");
delete document;
