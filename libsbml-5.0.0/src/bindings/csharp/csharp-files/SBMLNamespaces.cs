...
public class SBMLNamespaces : IDisposable {
 ...
 public SBMLNamespaces() : this(libsbmlPINVOKE.new_SBMLNamespaces__SWIG_2(), true) {
   ...
   *
   */
 public SBMLNamespaces(long level, long version, string pkgName, long pkgVersion, string pkgPrefix) : this(libsbmlPINVOKE.new_SBMLNamespaces__SWIG_3(level, version, pkgName, pkgVersion, pkgPrefix), true) {
   ...
   *
   */
 public SBMLNamespaces(long level, long version, string pkgName, long pkgVersion) : this(libsbmlPINVOKE.new_SBMLNamespaces__SWIG_4(level, version, pkgName, pkgVersion), true) {
    if (libsbmlPINVOKE.SWIGPendingException.Pending) throw libsbmlPINVOKE.SWIGPendingException.Retrieve();
  }
   ...
   */
 public SBMLNamespaces(SBMLNamespaces orig) : this(libsbmlPINVOKE.new_SBMLNamespaces__SWIG_5(SBMLNamespaces.getCPtr(orig)), true) {
    if (libsbmlPINVOKE.SWIGPendingException.Pending) throw libsbmlPINVOKE.SWIGPendingException.Retrieve();
  }
 ...
 public XMLNamespaces getNamespaces() {
   ...
   * <c>&lt;sbml&gt;</c> element of a model.  It gives the new
   * namespace a prefix of <c>html</c>.  @if clike
   * <code>
SBMLDocument sd;
try 
{
...
else
{
 ...
 public void addNamespace(string uri, string prefix) {
    libsbmlPINVOKE.SBMLNamespaces_addNamespace(swigCPtr, uri, prefix);
    if (libsbmlPINVOKE.SWIGPendingException.Pending) throw libsbmlPINVOKE.SWIGPendingException.Retrieve();
  }
   ...
   */
 public int removeNamespace(string uri) {
   ...
   */
 public int addPkgNamespace(string pkgName, long pkgVersion, string prefix) {
   ...
   * @see addNamespace(@if java String uri, String prefix@endif)
   */
 public int addPkgNamespace(string pkgName, long pkgVersion) {
   ...
   * added (just ignored) by this function. @link libsbmlcs.libsbml.LIBSBML_INVALID_ATTRIBUTE_VALUE LIBSBML_INVALID_ATTRIBUTE_VALUE@endlink
 ...
 public int addPkgNamespaces(XMLNamespaces xmlns) {
   ...
   * @li @link libsbmlcs.libsbml.LIBSBML_INDEX_EXCEEDS_SIZE LIBSBML_INDEX_EXCEEDS_SIZE @endlink
   */
 public int removePkgNamespace(long level, long version, string pkgName, long pkgVersion) {
   ...
   */
 public static bool isSBMLNamespace(string uri) {
