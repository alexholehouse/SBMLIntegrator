...
public class ListOfUnitDefinitions : ListOf {
   ...
   */
 public ListOfUnitDefinitions(long level, long version) : this(libsbmlPINVOKE.new_ListOfUnitDefinitions__SWIG_0(level, version), true) {
  }
   ...
   */
 public ListOfUnitDefinitions(SBMLNamespaces sbmlns) : this(libsbmlPINVOKE.new_ListOfUnitDefinitions__SWIG_1(SBMLNamespaces.getCPtr(sbmlns)), true) {
  }
 ...
 public new UnitDefinition get(long n) {
   ...
   * @see size()
   */
 public new UnitDefinition get(string sid) {
 ...
 public new UnitDefinition remove(long n) {
   ...
   * returned item.
   */
 public new UnitDefinition remove(string sid) {
