...
public class ListOfRules : ListOf {
   ...
   */
 public ListOfRules(long level, long version) : this(libsbmlPINVOKE.new_ListOfRules__SWIG_0(level, version), true) {
  }
   ...
   */
 public ListOfRules(SBMLNamespaces sbmlns) : this(libsbmlPINVOKE.new_ListOfRules__SWIG_1(SBMLNamespaces.getCPtr(sbmlns)), true) {
  }
 ...
 public new Rule get(long n) {
   ...
   * @see size()
   */
 public new Rule get(string sid) {
 ...
 public new Rule remove(long n) {
   ...
   * returned item.
   */
 public new Rule remove(string sid) {
