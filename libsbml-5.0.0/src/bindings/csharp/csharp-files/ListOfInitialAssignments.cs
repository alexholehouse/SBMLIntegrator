...
public class ListOfInitialAssignments : ListOf {
   ...
   */
 public ListOfInitialAssignments(long level, long version) : this(libsbmlPINVOKE.new_ListOfInitialAssignments__SWIG_0(level, version), true) {
  }
   ...
   */
 public ListOfInitialAssignments(SBMLNamespaces sbmlns) : this(libsbmlPINVOKE.new_ListOfInitialAssignments__SWIG_1(SBMLNamespaces.getCPtr(sbmlns)), true) {
  }
