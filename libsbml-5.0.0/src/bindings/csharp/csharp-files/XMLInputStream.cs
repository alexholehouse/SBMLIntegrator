...
public class XMLInputStream : IDisposable {
   ...
   */
 /* libsbml-internal */ public XMLInputStream(string content, bool isFile, string library, XMLErrorLog errorLog) : this(libsbmlPINVOKE.new_XMLInputStream__SWIG_0(content, isFile, library, XMLErrorLog.getCPtr(errorLog)), true) {
   ...
   * @if notcpp @docnote @htmlinclude warn-default-args-in-docs.html @endif
   */
 /* libsbml-internal */ public XMLInputStream(string content, bool isFile, string library) : this(libsbmlPINVOKE.new_XMLInputStream__SWIG_1(content, isFile, library), true) {
    if (libsbmlPINVOKE.SWIGPendingException.Pending) throw libsbmlPINVOKE.SWIGPendingException.Retrieve();
  }
   ...
   * @if notcpp @docnote @htmlinclude warn-default-args-in-docs.html @endif
   */
 /* libsbml-internal */ public XMLInputStream(string content, bool isFile) : this(libsbmlPINVOKE.new_XMLInputStream__SWIG_2(content, isFile), true) {
  }
   ...
   * @if notcpp @docnote @htmlinclude warn-default-args-in-docs.html @endif
   */
 /* libsbml-internal */ public XMLInputStream(string content) : this(libsbmlPINVOKE.new_XMLInputStream__SWIG_3(content), true) {
  }
   ...
   */
 /* libsbml-internal */ public string getEncoding() {
   ...
   */
 /* libsbml-internal */ public string getVersion() {
   ...
   */
 /* libsbml-internal */ public XMLErrorLog getErrorLog() {
   ...
   * otherwise.
   */
 /* libsbml-internal */ public bool isEOF() {
   ...
   */
 /* libsbml-internal */ public bool isError() {
   ...
   */
 /* libsbml-internal */ public bool isGood() {
   ...
   */
 /* libsbml-internal */ public XMLToken next() {
   ...
   * @return the next XMLToken or EOF (XMLToken.isEOF() == true).
   */
 /* libsbml-internal */ public XMLToken peek() {
   ...
   */
 /* libsbml-internal */ public void skipPastEnd(XMLToken element) {
   ...
   * element or EOF.
   */
 /* libsbml-internal */ public void skipText() {
   ...
   * @li @link libsbmlcs.libsbml.@link libsbmlcs.libsbml.LIBSBML_OPERATION_FAILED LIBSBML_OPERATION_FAILED @endlink @link libsbmlcs.libsbml.LIBSBML_OPERATION_FAILED LIBSBML_OPERATION_FAILED @endlink @endlink
   */
 /* libsbml-internal */ public int setErrorLog(XMLErrorLog log) {
   ...
   * debugging purposes.
   */
 /* libsbml-internal */ public string toString() {
 ...
 /* libsbml-internal */ public SBMLNamespaces getSBMLNamespaces() {
   ...
   * debugging purposes.
   */
 /* libsbml-internal */ public void setSBMLNamespaces(SBMLNamespaces sbmlns) {
