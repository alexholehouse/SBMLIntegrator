 ...
 * <c>ULONG_MAX</c> in C and C++.)  The probability that a true line
 ...
 * constants defined in the interface class <c><a
 * href='libsbmlcs.libsbml.html'>libsbmlcs.libsbml</a></c>.  This is
 ...
 * actual names of the constants, prepend <c>LIBSBML_CAT_</c> to the
 * category names and <c>LIBSBML_SEV_</c> to the severity names
 ...
 * <c>libsbmlcs.libsbml</c> in the file '<a
...
public class XMLError : IDisposable {
 ...
 public string getShortMessage() {
   ...
   * equal to the constant named <c>ULONG_MAX</c> in C and C++.)  The
