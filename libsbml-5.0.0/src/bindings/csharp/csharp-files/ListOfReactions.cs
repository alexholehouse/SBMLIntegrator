...
public class ListOfReactions : ListOf {
   ...
   */
 public ListOfReactions(long level, long version) : this(libsbmlPINVOKE.new_ListOfReactions__SWIG_0(level, version), true) {
  }
   ...
   */
 public ListOfReactions(SBMLNamespaces sbmlns) : this(libsbmlPINVOKE.new_ListOfReactions__SWIG_1(SBMLNamespaces.getCPtr(sbmlns)), true) {
  }
 ...
 public new Reaction get(long n) {
   ...
   * @see size()
   */
 public new Reaction get(string sid) {
 ...
 public new Reaction remove(long n) {
   ...
   * returned item.
   */
 public new Reaction remove(string sid) {
