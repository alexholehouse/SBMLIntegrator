...
public class SBaseExtensionPoint : IDisposable {
   ...
   * constructor
   */
 public SBaseExtensionPoint(string pkgName, int typeCode) : this(libsbmlPINVOKE.new_SBaseExtensionPoint__SWIG_0(pkgName, typeCode), true) {
   ...
   * copy constructor
   */
 public SBaseExtensionPoint(SBaseExtensionPoint orig) : this(libsbmlPINVOKE.new_SBaseExtensionPoint__SWIG_1(SBaseExtensionPoint.getCPtr(orig)), true) {
    if (libsbmlPINVOKE.SWIGPendingException.Pending) throw libsbmlPINVOKE.SWIGPendingException.Retrieve();
  }
   ...
   * clone 
   */
 public SBaseExtensionPoint clone() {
