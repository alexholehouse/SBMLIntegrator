 ...
 * an <c>&lt;annotation&gt;</c> element attached to an SBML component
 ...
 * the XML tag name of an SBML model component (e.g., <c>model</c>,
 * <c>reaction</c>, etc.) and the placeholder 
 ...
 * <c>'http://biomodels.net/model-qualifiers'</c> (for model
 * qualifiers) or <c>'http://biomodels.net/biology-qualifiers'</c>
 ...
 * given SBML <c>&lt;annotation&gt;</c> element are read by
...
public class CVTerm : IDisposable {
   ...
   * stored in <c>&lt;annotation&gt;</c> elements attached to
   * individual SBML elements.  The format for storing the content inside
   * SBML <c>&lt;annotation&gt;</c> elements is a subset of W3C RDF
   ...
   * appropriate SBML <c>&lt;annotation&gt;</c> structure.
   *
 ...
 public CVTerm() : this(libsbmlPINVOKE.new_CVTerm__SWIG_1(), true) {
   ...
   * <c>'http://biomodels.net/model-qualifiers'</c> (for
   * model qualifiers) and
   * <c>'http://biomodels.net/biology-qualifiers'</c> (for
 ...
 public int getBiologicalQualifierType() {
   ...
   * &quot;<c>rdf:resource</c>&quot;) but a different value, and the
 ...
 public int setBiologicalQualifierType(int type) {
   ...
   * @see setQualifierType(@if java int type@endif)
   */
 public int setModelQualifierType(string qualifier) {
   ...
   * @see setQualifierType(@if java int type@endif)
   */
 public int setBiologicalQualifierType(string qualifier) {
   ...
   * <c>&lt;annotation&gt;</c> element attached to an SBML component
   * such as Species, Compartment, etc.
   *
   * The specific RDF element used in this SBML format for referring to
   * external entities is <c>&lt;rdf:Description&gt;</c>, with a
   * <c>&lt;rdf:Bag&gt;</c> element containing one or more
   * <c>&lt;rdf:li&gt;</c> elements.  Each such element refers to a
 ...
 public int addResource(string resource) {
   ...
   * e.g., <c>'http://www.geneontology.org/#GO:0005892'</c>.
   *
   * @return integer value indicating success/failure of the
   * function. The possible values
   * returned by this function are:
