 ...
 * string (e.g., <c>&lt;annotation&gt;...&lt;/annotation&gt;</c>)
...
public class XMLNode : XMLToken {
 ...
 public XMLNode(string chars) : this(libsbmlPINVOKE.new_XMLNode__SWIG_13(chars), true) {
   ...
   * (<c>stream.peek().isStart() == true</c>) and will be read until
   * the matching end element is found.
   *
   * @param stream XMLInputStream from which XMLNode is to be created.
   */
 /* libsbml-internal */ public XMLNode(XMLInputStream stream) : this(libsbmlPINVOKE.new_XMLNode__SWIG_14(XMLInputStream.getCPtr(stream)), true) {
    if (libsbmlPINVOKE.SWIGPendingException.Pending) throw libsbmlPINVOKE.SWIGPendingException.Retrieve();
  }
   ...
   */
 public XMLNode(XMLNode orig) : this(libsbmlPINVOKE.new_XMLNode__SWIG_15(XMLNode.getCPtr(orig)), true) {
    if (libsbmlPINVOKE.SWIGPendingException.Pending) throw libsbmlPINVOKE.SWIGPendingException.Retrieve();
  }
 ...
 public int addChild(XMLNode node) {
  ...
  /**
   * Inserts a copy of the given node as the <c>n</c>th child of this
   * XMLNode.
   *
   ...
   * @param node an XMLNode to be inserted as <c>n</c>th child.
   *
 ...
 public XMLNode insertChild(long n, XMLNode node) {
  ...
  /**
   * Removes the <c>n</c>th child of this XMLNode and returns the
   * removed node.
   *
 ...
 public int removeChildren() {
  ...
  /**
   * Returns the <c>n</c>th child of this XMLNode.
   *
   ...
   * 
   * @return the  <c>n</c>th child of this XMLNode.
   */
 ...
 public int getIndex(string name) {
	 ...
	 *
	 * @return bool indicating whether this XMLNode has a child with the given name.
	 */
 public bool hasChild(string name) {
	 ...
	 *
	 * @return bool indicating whether this XMLNode represents the same XML tree as another.
	 */
 ...
 public static string convertXMLNodeToString(XMLNode node) {
   ...
   * <c>&lt;html&gt;</c>, <c>&lt;body&gt;</c>,
   * <c>&lt;annotation&gt;</c>, or <c>&lt;notes&gt;</c>.  In
