...
public class ListOfConstraints : ListOf {
   ...
   */
 public ListOfConstraints(long level, long version) : this(libsbmlPINVOKE.new_ListOfConstraints__SWIG_0(level, version), true) {
  }
   ...
   */
 public ListOfConstraints(SBMLNamespaces sbmlns) : this(libsbmlPINVOKE.new_ListOfConstraints__SWIG_1(SBMLNamespaces.getCPtr(sbmlns)), true) {
  }
