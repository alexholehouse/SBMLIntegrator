...
public class ListOfCompartments : ListOf {
   ...
   */
 public ListOfCompartments(long level, long version) : this(libsbmlPINVOKE.new_ListOfCompartments__SWIG_0(level, version), true) {
  }
   ...
   */
 public ListOfCompartments(SBMLNamespaces sbmlns) : this(libsbmlPINVOKE.new_ListOfCompartments__SWIG_1(SBMLNamespaces.getCPtr(sbmlns)), true) {
  }
 ...
 public new Compartment get(long n) {
   ...
   * @see size()
   */
 public new Compartment get(string sid) {
 ...
 public new Compartment remove(long n) {
   ...
   * returned item.
   */
 public new Compartment remove(string sid) {
