 ...
 * YYYY-MM-DDThh:mm:ssXHH:ZZ (e.g., <c>1997-07-16T19:20:30+01:00</c>)
 ...
 * </ul>
 *
 * To illustrate the time zone offset, a value of <c>-05:00</c> would
...
public class Date : IDisposable {
   ...
   * given: @c 0.)
   *
   * To illustrate the time zone offset, a value of <c>-05:00</c>
 ...
 public Date() : this(libsbmlPINVOKE.new_Date__SWIG_9(), true) {
   ...
   * <c>1997-07-16T19:20:30+01:00</c>, which would represent July 16,
 ...
 public long getMinutesOffset() { return (long)libsbmlPINVOKE.Date_getMinutesOffset(swigCPtr); }
   ...
   * </ul>
   *
   * An example date/time string is <c>1997-07-16T19:20:30+01:00</c>,
 ...
 public int setDateAsString(string date) {
   ...
   * <c>1997-07-16T19:20:30+01:00</c>) where XHH:ZZ is the time zone
