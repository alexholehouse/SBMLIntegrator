...
public class ListOfFunctionDefinitions : ListOf {
   ...
   */
 public ListOfFunctionDefinitions(long level, long version) : this(libsbmlPINVOKE.new_ListOfFunctionDefinitions__SWIG_0(level, version), true) {
  }
   ...
   */
 public ListOfFunctionDefinitions(SBMLNamespaces sbmlns) : this(libsbmlPINVOKE.new_ListOfFunctionDefinitions__SWIG_1(SBMLNamespaces.getCPtr(sbmlns)), true) {
  }
 ...
 public new FunctionDefinition get(long n) {
   ...
   * @see size()
   */
 public new FunctionDefinition get(string sid) {
 ...
 public new FunctionDefinition remove(long n) {
   ...
   * returned item.
   */
 public new FunctionDefinition remove(string sid) {
