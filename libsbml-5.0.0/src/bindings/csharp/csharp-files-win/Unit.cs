 ...
 * <c>UNIT_KIND_</c>@endif, discussed in a separate section below.
 *
 ...
 * <c>UNIT_KIND_</c>.  These constants are defined in the class
 * <c><a href='libsbmlcs.libsbml.html'>libsbmlcs.libsbml</a></c>.
...
public class Unit : SBase {
 ...
 public void initDefaults() {
   ...
   * with <c>UNIT_KIND_</c> defined in the class
   * <c><a href='libsbmlcs.libsbml.html'>libsbmlcs.libsbml</a></c>.
   * @endif@if python
   * @return the value of the 'kind' attribute of this Unit as a
   * value from the set of constants whose names begin
 ...
 public bool isSetMultiplier() {
   ...
   * names begin with <c>UNIT_KIND_</c> in <c><a
   * href='libsbmlcs.libsbml.html'>libsbmlcs.libsbml</a></c>.
   * @endif@if python
   * @param kind a unit identifier chosen from the set of constants whose
   * names begin with <c>UNIT_KIND_</c> in @link libsbml libsbml@endlink.
   * @endif
   *
  ...
  * multiplier=<c>'0.001'</c> scale=@c '0' exponent=@c '1'.
  *
