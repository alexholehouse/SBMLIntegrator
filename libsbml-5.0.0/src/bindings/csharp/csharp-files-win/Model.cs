 ...
 * and <c>create<span class='placeholder'><em>Object</em></span>()</c>
 ...
 * 
 * In general, the recommended approach is to use the <c>create<span
 * class='placeholder'><em>Object</em></span>()</c> methods.  These
 ...
 * 
 * The <c>create<span
 * class='placeholder'><em>Object</em></span>()</c> methods return a
 ...
 * become the <c>&lt;listOf<span
 * class='placeholder'><em>Object</em></span>s&gt;</c> elements in the
 * finished XML rendition of SBML.)  In the example above,
 * Model::createSpecies() adds the created species directly to the
 * <c>&lt;listOfSpecies<i></i>&gt;</c> list in the model.  Subsequently,
...
public class Model : SBase {
 ...
 public new int setAnnotation(XMLNode annotation) {
   ...
   */
 public new int setAnnotation(string annotation) {
 ...
 public long getNumEvents() { return (long)libsbmlPINVOKE.Model_getNumEvents(swigCPtr); }
   ...
   */
 /* libsbml-internal */ public void convertL1ToL2() {
   ...
   * @return true if the given ASTNode is a bool.
   */
 /* libsbml-internal */ public void convertL1ToL3() {
   ...
   * @return true if the given ASTNode is a bool.
   */
 /* libsbml-internal */ public void convertL2ToL3() {
   ...
   * @return true if the given ASTNode is a bool.
   */
 /* libsbml-internal */ public void convertL2ToL1(bool strict) {
   ...
   * @return true if the given ASTNode is a bool.
   */
 /* libsbml-internal */ public void convertL2ToL1() {
   ...
   * @return true if the given ASTNode is a bool.
   */
 /* libsbml-internal */ public void convertL3ToL1() {
   ...
   * @return true if the given ASTNode is a bool.
   */
 /* libsbml-internal */ public void convertL3ToL2() {
   ...
   * @return true if the given ASTNode is a bool.
   */
 /* libsbml-internal */ public void addModifiers() {
   ...
   * @return true if the given ASTNode is a bool.
   */
 /* libsbml-internal */ public void addConstantAttribute() {
   ...
   * @return true if the given ASTNode is a bool.
   */
 /* libsbml-internal */ public void setSpatialDimensions(double dims) {
   ...
   * @return true if the given ASTNode is a bool.
   */
 /* libsbml-internal */ public void setSpatialDimensions() {
   ...
   * @return true if the given ASTNode is a bool.
   */
 /* libsbml-internal */ public void addDefinitionsForDefaultUnits() {
   ...
   * @return true if the given ASTNode is a bool.
   */
 /* libsbml-internal */ public void convertParametersToLocals(long level, long version) {
   ...
   * @return true if the given ASTNode is a bool.
   */
 /* libsbml-internal */ public void setSpeciesReferenceConstantValueAndStoichiometry() {
   ...
   * @return true if the given ASTNode is a bool.
   */
 /* libsbml-internal */ public void removeParameterRuleUnits() {
   ...
   * @return true if the given ASTNode is a bool.
   */
 /* libsbml-internal */ public void convertStoichiometryMath() {
   ...
   * @return true if the given ASTNode is a bool.
   */
 /* libsbml-internal */ public void assignRequiredValues() {
   ...
   * @return true if the given ASTNode is a bool.
   */
 /* libsbml-internal */ public void dealWithModelUnits() {
   ...
   * @return true if the given ASTNode is a bool.
   */
 /* libsbml-internal */ public void dealWithStoichiometry() {
