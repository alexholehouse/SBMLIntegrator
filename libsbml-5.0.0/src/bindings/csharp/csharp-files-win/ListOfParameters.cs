...
public class ListOfParameters : ListOf {
   ...
   */
 public ListOfParameters(long level, long version) : this(libsbmlPINVOKE.new_ListOfParameters__SWIG_0(level, version), true) {
  }
   ...
   */
 public ListOfParameters(SBMLNamespaces sbmlns) : this(libsbmlPINVOKE.new_ListOfParameters__SWIG_1(SBMLNamespaces.getCPtr(sbmlns)), true) {
  }
