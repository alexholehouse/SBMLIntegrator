 ...
 * Call @if java SBMLDocument::setConsistencyChecks(int categ, bool onoff) @else SBMLDocument::setConsistencyChecks() @endif to configure which checks
 ...
 * 
 * <li style='margin-bottom: 0.5em'>
 * Call @if java SBMLDocument::setConsistencyChecks(int categ, bool onoff) @else SBMLDocument::setConsistencyChecks() @endif to configure which
...
public class SBMLDocument : SBase {
   ...
   * was released.  For this copy of libSBML, the value is <c>3</c>.
 ...
 public static long getDefaultLevel() { return (long)libsbmlPINVOKE.SBMLDocument_getDefaultLevel(); }
   ...
   * was released.  For this copy of libSBML, the value is <c>1</c>
   * (where the default Level of SBML is <c>3</c>).  The default
 ...
 public static long getDefaultVersion() { return (long)libsbmlPINVOKE.SBMLDocument_getDefaultVersion(); }
   ...
   * on the <c>&lt;sbml&gt;</c> element.  Application writers should
 ...
 public new Model getModel() {
   ...
   * any instances of their use within <c>&lt;math&gt;</c> elements.
   *
   ...
   * <c>&lt;math&gt;</c> element of the KineticLaw object contains
   * <c>f(s, p)</c>, where @c s and @c p are other identifiers
   * defined in the model.  The outcome of invoking this method is that the
   * <c>&lt;math&gt;</c> of the KineticLaw now represents the
 ...
 public bool expandFunctionDefinitions() {
   ...
   * object's <c>&lt;math&gt;</c> formula, and the corresponding
   ...
   * values for any components referred to by the <c>&lt;math&gt;</c>
 ...
 public bool expandInitialAssignments() {
   ...
   * conversion (defaults to <c> true </c>)
   *
 ...
 public Model createModel() {
   ...
   * @endif@if java
   * The possible categories (values to the argument @p category) are the
   * set of constants whose names begin with the characters <c>LIBSBML_CAT_</c>
   * in the interface class {@link libsbmlcs.libsbml}.
   * The following are the possible choices:
   * @endif@if python 
   * The possible categories (values to the argument @p category) are the
   * set of constants whose names begin with the characters <c>LIBSBML_CAT_</c>
 ...
 public SBMLErrorLog getErrorLog() {
   ...
   */
 public new XMLNamespaces getNamespaces() {
   ...
   */
 public int enableDefaultNS(string package, bool flag) {
   ...
   * @return a bool 
   */
 public bool isEnabledDefaultNS(string package) {
   ...
   * @li @link libsbmlcs.libsbml.LIBSBML_PKG_UNKNOWN_VERSION LIBSBML_PKG_UNKNOWN_VERSION @endlink
   */
 public int setPkgRequired(string package, bool flag) {
   ...
   * @param package the name or URI of the package extension.
   *
   * @return bool flag indicating whether the package is flagged as
   * being required.
   */
 ...
 public bool isSetPkgRequired(string package) {
   ...
   * @return a bool
   */
 public bool isIgnoredPkg(string pkgURI) {
