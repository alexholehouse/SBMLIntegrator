...
class libsbmlPINVOKE {
  ...
  public static extern void SBMLNamespaces_addNamespace(HandleRef jarg1, [MarshalAs(UnmanagedType.LPWStr)]string jarg2, [MarshalAs(UnmanagedType.LPWStr)]string jarg3);
