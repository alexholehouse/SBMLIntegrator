 ...
 * @author  Ben Kovitz
 *
 * $Id: local.cpp 10190 2009-09-23 16:03:35Z ajouraku $
 * $HeadURL: https://sbml.svn.sourceforge.net/svnroot/sbml/trunk/libsbml/src/bindings/python/local.cpp $
 *
 * <!--------------------------------------------------------------------------
...
int fixNegativeIndex(int i, ListOf *l){
  if (i < 0){
    return i + l->size();
  } else {
    return i;
