...
public class ListOfCompartments extends ListOf {
   ...
   */
 public ListOfCompartments(long level, long version) {
   ...
   */
 public ListOfCompartments(SBMLNamespaces sbmlns) {
   ...
   */
 public ListOfCompartments cloneObject() {
 ...
 public int getTypeCode() {
    return libsbmlJNI.ListOfCompartments_getTypeCode(swigCPtr, this);
  }
 ...
 public Compartment get(long n) {
   ...
   * @see #size()
   */
 public Compartment get(String sid) {
   ...
   * @see #size()
   */
 public Compartment remove(long n) {
   ...
   * returned item.
   */
 public Compartment remove(String sid) {
