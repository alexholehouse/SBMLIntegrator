 ...
 *
 * $Id: zipfstream.cpp 8704 2009-01-04 02:26:05Z mhucka $
 * $HeadURL: https://sbml.svn.sourceforge.net/svnroot/sbml/trunk/libsbml/src/compress/zipfstream.cpp $
 *
 * <!--------------------------------------------------------------------------
...
// jouraku
  int bytes_read = unzipread(rfile, buffer, buffer_size);
