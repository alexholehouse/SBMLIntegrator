...
libdir=/home/alex/Documents/imperial/project/work/SBMLIntegrator/source/libsbml/lib
        ...
        *.o)
        ...
        lib*.la | */lib*.la)
            mkdir -p "${stage_dir}/${libdir}" && \
                eval "/home/alex/Documents/imperial/project/work/SBMLIntegrator/source/libsbml-5.0.0/libtool --mode=install cp \"$1\" \"${stage_dir}/${libdir}\""
...
eval "/home/alex/Documents/imperial/project/work/SBMLIntegrator/source/libsbml-5.0.0/libtool --tag=\"$TAG\" --mode=link \"$LD\" -rpath \"${libdir}\" -inst-prefix-dir \"${stage_dir}\" -module -avoid-version -export-dynamic -shrext "${dllibext}" -o \"${out_dir}/${out_filename}.la\" $args" && \
    eval "/home/alex/Documents/imperial/project/work/SBMLIntegrator/source/libsbml-5.0.0/libtool --mode=install cp \"${out_dir}/${out_filename}.la\" \"${stage_dir}/${libdir}/${out_filename}.la\"" 
