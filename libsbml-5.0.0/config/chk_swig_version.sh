#!/bin/sh
# $Id: chk_swig_version.sh.in 12785 2011-02-08 18:49:42Z luciansmith $
# $URL: https://sbml.svn.sourceforge.net/svnroot/sbml/branches/libsbml-5/config/chk_swig_version.sh.in $
# -----------------------------------------------------------------------------
